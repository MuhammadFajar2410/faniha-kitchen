                                ...
                                <div class="single-widget category">
                                    ...
                                    <ul class="categor-list">
										@php
											...
											$categories=App\Models\Categories::getCategoryStatusTrue();
										@endphp
										@if($categories)
										<li>
											@foreach($categories as $category)
												<li><a href="{{route('product-cat',$category->slug)}}">{{$category->category_name}}</a></li>
											@endforeach
										</li>
										@endif
                                ...
                                <div class="single-widget recent-post">
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                <h5><a href="{{url('product-detail',$product->slug)}}">{{$product->product_name}}</a></h5>
                                                @php
                                ...
                                <div class="single-widget category">
                                    ...
                                    <ul class="categor-list">
                                        ...
                                        @foreach($brands as $brand)
                                            <li><a href="{{route('product-brand',$brand->slug)}}">{{$brand->brand_name}}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                                <!--/ End Single Widget -->
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														<div class="product-content">
															...
															<h3 class="title"><a href="{{url('product-detail',$product->slug)}}">{{$product->product_name}}</a></h3>
														</div>
														<p class="des pt-2">{{ $product->brand->brand_name }}</p>
														<a href="{{ route('add-to-cart',['slug' => $product->slug]) }}" class="btn cart">Buy Now!</a>
													</div>
												</div>
											</div>
										</div>
      ...
      $('#addToCart').submit(function (e) {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            // Lakukan sesuatu dengan tanggapan jika diperlukan
          },
