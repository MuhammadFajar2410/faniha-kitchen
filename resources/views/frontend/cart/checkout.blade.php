                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone" placeholder="" required value="{{ $profile->phone ?? ''}}" min="0">
                                            @error('phone')
                                                <span class='text-danger'>{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" cols="30" rows="2" value="{{ old('address') }}" class="form-control">{{ $profile->address ?? '' }}</textarea>
                                            @error('address1')
                                                <span class='text-danger'>{{$message}}</span>
                                            @enderror
                                        </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
										    <li class="order_subtotal" data-price="{{$total_price}}">Cart Subtotal<span>{{'Rp ' . number_format($total_price, 0, ',', '.')}}</span></li>
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                ...
                                                <input name="payment_method"  type="radio" value="midtrans"> <label> Other</label>
                                            </form-group>
